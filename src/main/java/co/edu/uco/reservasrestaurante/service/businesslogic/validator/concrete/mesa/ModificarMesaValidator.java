...
public final class ModificarMesaValidator implements Validator<MesaDomain>{

	private static final Validator<MesaDomain> instancia = new ModificarMesaValidator();
	
	private ModificarMesaValidator() {
		super();
	}
