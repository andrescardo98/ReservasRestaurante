...
public final class NumeroMesaRule implements Rule<Integer>{
	
private static final Rule<Integer> instancia = new NumeroMesaRule();
	
	private NumeroMesaRule() {
		super();
	}
	...
	private final void validarFormato(final int dato) {
		if (dato < 0 && dato > 10) {
			var mensajeUsuario = CatalogoMensajes.obtenerContenidoMensaje(CodigoMensaje.M00000299);
