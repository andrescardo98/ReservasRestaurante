...
public final class RegistrarPaisFacade implements Facade<PaisDTO>{
	...
	public void execute(PaisDTO dto) {
		...
		try {
			...
			var useCase = new RegistrarPaisUseCase(daoFactory);
			...
			var mensajeUsuario = CatalogoMensajes.obtenerContenidoMensaje(CodigoMensaje.M00000203);
			var mensajeTecnico = CatalogoMensajes.obtenerContenidoMensaje(CodigoMensaje.M00000204);
